  ...
  Widget _buildProjectInfo() {
    return Column(
      ...
      children: [
        ...
        // Description
        Text(
          'App de finanzas personales con escaneo OCR de facturas potenciado por la API de ChatGPT. '
          'Registra tus ingresos y gastos de forma automática escaneando tus recibos. '
        ...
        Wrap(
          ...
          children: [
            ...
            _buildTechTag('ChatGPT API', Icons.auto_awesome_rounded),
    ...
    final benefits = [
      {
        ...
        'desc': 'Escanea tus facturas con IA y registra gastos al instante',
      },
      {
      ...
      },
      {
        ...
        'desc': 'Solo toma una foto de tu recibo y la IA hace el resto',
      },
      {
